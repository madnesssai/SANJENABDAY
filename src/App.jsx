    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Sanjena</span>! 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Sanjena's</span>{" "}
                special day! 🎂
              </>
            )}
          </h1>
          <p>Hai kutty, i made something for you. I worked for a long time to make you this. but your gonna have to wait until your special day to see what is inside hehe. 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Saimadhav 💖</h2>
          <p className="final-subtitle">I love you my pookie. Thank you for always making my day better hehe.✨</p>
        </section>
      </div>
